...
public:
	TKADCCONTROL_DL750();
	int TKADCCONTROL_DL750::GetStatusCondition(TKADCCONTROL_DL750::CONDITIONFLAG flag = CONDITIONFLAG::ALL);
...
public:
	TKADCCONTROL_DL850();
	int TKADCCONTROL_DL850::GetStatusCondition(TKADCCONTROL_DL850::CONDITIONFLAG flag = CONDITIONFLAG::ALL);
	int Delete(std::string file_name);
};
