...
private:
	...
	int SaveSettings(void)
	{
		...
		if (radioButton4->Checked)
			...
			(*Setting)[group]["ElectronCurrentCollectionSurfaceArea"]
		...
		if (radioButton10->Checked)
			...
			(*Setting)[group]["IonCurrentCollectionSurfaceArea"]
	...
	int LoadSettings(void)
	{
		...
		if ((*Setting)[group]["ProbeCurrentPolarity"] == "IonCurrent") {
		...
		if ((*Setting)[group]["GasType"] == "Ar")
			radioButton11->Checked = true;
		else if ((*Setting)[group]["GasType"] == "He")
			radioButton12->Checked = true;
		else if ((*Setting)[group]["GasType"] == "Proton")
		...
		if ((*Setting)[group]["ElectronCurrentCollectionSurfaceArea"] == "2rl") {
			...
			textBox10->Text = gcnew System::String((std::to_string(std::stod(
				((*Setting)[group]["ElectronCurrentCollectionSurfaceArea"]).c_str())*1e-6)).c_str());
		}
		...
		if ((*Setting)[group]["IonCurrentCollectionSurfaceArea"] == "2rl") {
			...
			textBox11->Text = gcnew System::String((std::to_string(std::stod(
				((*Setting)[group]["IonCurrentCollectionSurfaceArea"]).c_str())*1e-6)).c_str());
		}
...
#pragma region Windows Form Designer generated code
	...
	void InitializeComponent(void)
	{
		...
		// textBox1
		// 
		this->textBox1->Location = System::Drawing::Point(150, 51);
		...
		this->label4->Size = System::Drawing::Size(51, 12);
		...
		this->radioButton15->Size = System::Drawing::Size(71, 16);
		this->radioButton15->TabIndex = 11;
		this->radioButton15->TabStop = true;
		this->radioButton15->Text = L"自動計算";
		...
		this->groupBox5->Location = System::Drawing::Point(136, 264);
		...
		this->groupBox9->Size = System::Drawing::Size(108, 128);
