...
set margin 0, 0, 0, 0
set label 1 left at graph 0.000000, 1.060000 "CH6 - DL750"
...
plot "D7T00016.CSV" every 10 using (-0.5 + (column(0)) * 10 * 2e-05):3 with line
set print "PlotRaw_DL750_CH6.tmp"
print GPVAL_Y_MIN
print GPVAL_Y_MAX
